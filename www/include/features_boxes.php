...
//
// $Id: features_boxes.php,v 1.53 2000/01/13 18:36:35 precision Exp $
...
function show_top_downloads() {
	$return = html_box1_top('Top Project Downloads',0);
...
function show_sitestats() {
	$return = html_box1_top('SF Statistics',0);
...
function show_newest_projects() {
	$return = html_box1_top('Newest Projects',0);
...
function show_highest_ranked_projects() {
	$return = html_box1_top('Highest User-Ranked Projects',0);
