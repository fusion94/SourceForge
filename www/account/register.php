...
//
// $Id: register.php,v 1.41 2000/01/13 18:36:34 precision Exp $
...
function register_valid()	{
	...
	$GLOBALS[newuserid] = db_insertid(db_query(
		"INSERT INTO user (user_name,user_pw,unix_pw,realname,email,add_date,"
	...
	mail($GLOBALS[form_email],"SourceForge Account Registration",$message,"From: admin@sourceforge.net");
