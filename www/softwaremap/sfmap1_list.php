...
//
// $Id: sfmap1_list.php,v 1.2 2000/04/24 13:58:52 dtype Exp $
...
print '<P>View the <A href="trove_list.php">[Trove Software Map]</A> which is currently
	in development, and will soon
	be replacing this map.<HR>';
...
for ($i=0;$i<$folders_len;$i++) {
	...
	if ($i != ($folders_len-1)) print "<A href=\"/softwaremap/sfmap1_list.php?form_cat=$folders[$i]\">";
...
while ($row_sub = db_fetch_array($res_sub)) {
	...
	print "<a href=\"sfmap1_list.php?form_cat=$row_sub[category_id]\">";
